...
export function useFetchTeamMembers(query){
    ...
    useEffect(() => {
        const fetchTeamMemberData = async () => {
            try {
                const { data, status} = !query ? await axios.get(`/eduafrica/team/getAllTeam`, {withCredentials: true}) : await axios.get(`/eduafrica/team/getTeam/${query}`, {withCredentials: true})
                //console.log('Data from Hooks>>>', data, 'STATUS', status)
