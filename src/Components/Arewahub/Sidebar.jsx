...
import { arewahublinks } from "../../Data/menuLinks.jsx";
import { useState } from "react";
import LogoImg from '../../assets/image/arewahublogo.png'
...
function Sidebar() {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-arewahub-main-color">
      <div className="flex flex-col gap-6 pt-5">
        <div className="flex flex-col gap-[50px]">
          {/* LOGO */}
          <div className="relative flex items-center gap-[10px] px-[30px]">
            <Logo img={LogoImg} white={true} style={`!w-[134px] !h-[41.78px]`} />
            ...
            {
              showMenu && (
                <div className="absolute right-0 top-12 bg-white rounded-[8px] shadow-md border-[1px] border-gray-200 p-5 min-w-[207px]">
