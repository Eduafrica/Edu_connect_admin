...
function ContactUsCard({ contactUsData, loading }) {
    ...
    <div className="p">
      ...
      <div className="px-4 py-5 rounded-t-[12px] border-[1px] border-white bg-white shadow-sm">
        ...
        <div className="w-full flex items-center gap-[50px]">
          <div className="w-fit flex items-center min-w-[140px]">
            <h2 className="text-lg font-semibold text-[#121212]">34 Testimonies</h2>
          </div>
