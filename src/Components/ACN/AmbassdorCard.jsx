...
function AmbassdorCard({ teamData, loading, showFilter, showMenuList, showSearch, text, showPagination }) {
      ...
      {showPagination && (
        <div className="flex items-center justify-between border-t-[1px] border-t-gray-200 py-4 px-6">
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 mr-2 text-sm text-white bg-main-color rounded-md"
          >
            Previous
          </button>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 ml-2 text-sm text-white bg-main-color rounded-md"
          >
            Next
          </button>
        </div>
