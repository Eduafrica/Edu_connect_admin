...
import { eduafricalinks } from "../../Data/menuLinks.jsx";
import { useState } from "react";
import { logout } from "../../Helpers/api.js";
import { useDispatch } from "react-redux";
import { signOut } from "../../Redux/Admin/adminSlice.js";
import LogoImg from '../../assets/image/eduafricaLogo.png'

function Sidebar() {
  const navigate = useNavigate()
  const dispatch = useDispatch()
  const menu = eduafricalinks;
        ...
        <div className="flex flex-col gap-[50px]">
          ...
          <div className="relative flex items-center gap-[10px] px-[30px]">
            <div className="flex items-center gap-[10px]">
                <Logo img={LogoImg} style={`!w-[58.99px] !h-[48.31px]`} />
                <p className="text-[16px] font-semibold text-[#F2F4F7]">EduAfrica</p>
            </div>
