...
function ResetPasswordSentSuccess() {
    ...
    <div className="page flex-row">
      ...
      <div className="h-full w-full flex flex-col items-center">
        <div className="flex flex-col items-start gap-[9rem]">
            ...
            <ResetPasswordSentSuccessCard setErrorText={setErrorText} setSuccessText={setSuccessText} />
...
export default ResetPasswordSentSuccess
