    ...
    <div className="page flex-row">
      ...
      <div className="relative ml-[280px] w-[calc(100vw-280px)]">
        ...
        <div className="bg-bgColor pad1 flex flex-col gap-[39px]">
            ...
            {/**BOTTOM */}
            <div className="">
                 <NewAndUpdatesCard newsData={data} loading={isFetching} showFilter={true} showMenuList={false} showPagination={true} showSearch={true}  />
            </div>
...
export default AcnNewsAndUpdates;
