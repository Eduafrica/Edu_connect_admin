...
import MyDetails from "../../Components/ACN/MyDetails";
import Password from "../../Components/ACN/Password";
              ...
              <DashBoardLinks name={'acn'} color={`text-acn-main-color border-acn-main-color`} />
                ...
                <div className="">
                    <MenuList
                        ...
                        activeStyle={`!text-acn-main-color !border-acn-main-color `}
                    />
