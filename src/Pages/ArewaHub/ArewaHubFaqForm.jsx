...
import { newFaq, updateFaq } from "../../Helpers/arewahub/api";
...
function ArewaHubFaqForm({ acnFaqId, setAcnFaqId }) {
        ...
        <div className="relative bg-bgColor pad1 flex flex-col gap-[39px]">
            ...
            <DashBoardLinks name={'arewahub'} color={`text-arewahub-main-color border-arewahub-main-color`} />
                ...
                <div className="flex items-center justify-center gap-8 flex-col">
                    ...
                    <p className="text-gray-600 font-normal text-[20px] text-center">Everything you need to know about the Arewa hub</p>
                </div>
                ...
                <div className="w-[299px]">
                    {
                        loading ? (
                            <LoadingBtn style={`!bg-arewahub-main-color !border-arewahub-main-color`} />
                        ) : (
                            <Button onCLick={handleSave} text={`Save`} style={`!bg-arewahub-main-color !border-arewahub-main-color`}  />
                        )
                    }
                </div>
...
export default ArewaHubFaqForm;
