...
function ArewaHubTestimoniesInfo() {
            ...
            <div className="flex flex-col gap-[30px]">
                ...
                <div className="flex gap-[56px]">
                    <div onClick={handleApprove} className="">
                        <Button text={`Add to website`} style={`!bg-arewahub-main-color !border-arewahub-main-color `} />
                    </div>
...
export default ArewaHubTestimoniesInfo;
