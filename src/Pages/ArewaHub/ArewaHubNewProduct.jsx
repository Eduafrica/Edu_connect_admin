...
import ArewaProductForm from "../../Components/Arewahub/ArewaProductForm";


function ArewaHubNewProduct() {
    ...
    <div className="page flex-row">
      ...
      <div className="relative ml-[280px] w-[calc(100vw-280px)]">
        ...
        <div className="bg-bgColor pad1 flex flex-col gap-[30px]">
            ...
            <div className="">
                {/**ADD HERE */}
                <ArewaProductForm setErrorMsg={setErrorMsg} setSuccessMsg={setSuccessMsg}  />
            </div>
...
export default ArewaHubNewProduct;
