...
import { useFetchContactMessage } from "../../Helpers/arewahub/fetch.hooks";
                                    ...
                                    <div className="flex flex-col gap-5">
...

                                        {
                                            loading ? (
                                                ...
                                                <Button text={'Send reply'} onCLick={handleReplyMessage} style={`!bg-arewahub-main-color !border-arewahub-main-color`} />
                                            )
                                        }
                                    </div>
                                </div>
...
export default ArewaHubContactUsInfo;
