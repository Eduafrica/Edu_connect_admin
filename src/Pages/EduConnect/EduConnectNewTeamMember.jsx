...
import { newTeam, editeam } from "../../Helpers/educonnect/api";

function EduConnectNewTeamMember() {
                    ...
                    <div className="flex flex-col gap-[30px]">
                        ...
                        <div className="card1">
                            <div className="flex items-center gap-[50px]">
                                <Link to={`/edu-connect/team`} className="">
                                    <IoIosArrowBack />
                                </Link>
                                <div>
                            ...
                            <div onClick={handleTeamMember} className="w-fit">
                                <Button
                                    disabled={loading}
                                    style={`!bg-main-color !border-none`}
...
export default EduConnectNewTeamMember;
